    ...
    let tests = vec![
         Test {
             ...
             expected: Recipe {
                 ...
                 nutritional_information: Some(NutritionalInformation { calories: 258.0 })
             },
         },
         Test {
             ...
             expected: Recipe{
                ...
                nutritional_information: Some(NutritionalInformation { calories: 354.52 })
                },
            },
            Test {
                ...
                expected: Recipe {
                    ...
                    nutritional_information: Some(NutritionalInformation { calories: 540.0 }),
                }
            },
        ];
