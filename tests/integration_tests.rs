...
use recipe_rs::{
    recipe::{Ingredient, Measure, NutritionalInformation, Recipe},
    scrapers,
};
use scraper::Html;
use url::Url;
...
fn download_dom(url: &Url) -> Result<Html> {
    let dom_text = ureq::get(&url.to_string())
        .call()?
        .into_body()
        .read_to_string()?;
            ...
            expected: Recipe {
                ...
                directions: vec![
                    ...
                    "Add the garam masala, turmeric and red pepper flakes to the pan and stir \
                     into the onion mixture. Add a few tablespoons of water if the mixture is too \
                     dry."
                        .to_string(),
                    ...
                    "Squeeze the lemon juice into the pan, and stir in the spinach as well until \
                     wilted. Add salt to taste. I used 1 teaspoon."
                        .to_string(),
                    "Serve with brown or white rice and Vegan Naan. Enjoy!".to_string(),
                ],
                nutritional_information: Some(NutritionalInformation {
                    serving_size: Some(1),
                    calories_kcal: Some(258.0),
                    carbohydrates_g: Some(28.0),
                    fat_g: Some(13.0),
                    protein_g: Some(11.0),
                    cholesterol_mg: None,
                    fiber_g: Some(12.0),
                    saturated_fat_g: Some(9.0),
                    unsaturated_fat_g: None,
                    trans_fat_g: None,
                    sodium_mg: Some(732.0),
                    sugar_g: Some(3.0),
                }),
            },
        },
            ...
            expected: Recipe {
                ...
                ingredients: vec![
                    ...
                    Ingredient {
                        name: "- olive oil".to_string(),
                        amounts: vec![],
                        modifier: Some("lemon juice".to_string()),
                    },
                ],
                directions: vec![
                    "poke the cubes into the skewers about 8 pork cubes".to_string(),
                    "- add salt &amp;amp; pepper, oregano, olive oil, lemon juice you can add 1 \
                     minced garlic clove too ( optional)"
                        .to_string(),
                    "- grill them or stir fry them for about 10 mins each side, once you turn \
                     side cover with a heavy lid over the souvlaki, that way will be cooked \
                     faster and some of the steams will keep it softer inside and won’t come out \
                     dry!"
                        .to_string(),
                    "- enjoy either as they are or with bread, or pita bread, tzatziki or \
                     tirokafteri or wrap them as a yiro! No matter how though, one thing is sure \
                     that are insanely delicious!"
                        .to_string(),
                ],
                nutritional_information: Some(NutritionalInformation {
                    calories_kcal: Some(354.52),
                    carbohydrates_g: Some(4.71),
                    fat_g: Some(28.63),
                    protein_g: Some(20.23),
                    cholesterol_mg: Some(70.06),
                    fiber_g: Some(1.63),
                    serving_size: Some(1),
                    saturated_fat_g: Some(6.99),
                    unsaturated_fat_g: None,
                    trans_fat_g: Some(0.14),
                    sodium_mg: None,
                    sugar_g: Some(0.91),
                }),
            },
            ...
            expected: Recipe {
                ...
                ingredients: vec![
                    ...
                    Ingredient {
                        ...
                        modifier: Some("(or water)".to_string()),
                    },
                    Ingredient {
                        name: "rice vinegar".to_string(),
                        amounts: vec![
                            Measure {
                                unit: "tbsp".to_string(),
                                upper_value: None,
                    ...
                    Ingredient {
                        ...
                        amounts: vec![
                            Measure {
                                unit: "tbsp".to_string(),
                                upper_value: Some(2.0),
                                value: 1.0,
                            },
                            Measure {
                                unit: "ml".to_string(),
                                upper_value: Some(30.0),
                                value: 15.0,
                            },
                        ],
                        modifier: Some("finely chopped".to_string()),
                    },
                    Ingredient {
                        name: "garlic".to_string(),
                        amounts: vec![Measure {
                    ...
                    Ingredient {
                        name: "toasted sesame oil".to_string(),
                        amounts: vec![
                            Measure {
                                unit: "tsp".to_string(),
                                upper_value: None,
                    ...
                    Ingredient {
                        name: "red bell peppers".to_string(),
                        amounts: vec![Measure {
                            unit: "whole".to_string(),
                            upper_value: None,
                            value: 2.0,
                        }],
                        modifier: Some("cut into strips".to_string()),
                    },
                    Ingredient {
                        name: "canola oil".to_string(),
                        amounts: vec![
                            Measure {
                                unit: "cup".to_string(),
                                upper_value: None,
                    ...
                    Ingredient {
                        name: "chicken skinless and boneless thighs chicken".to_string(),
                        amounts: vec![
                            Measure {
                                unit: "lb".to_string(),
                                upper_value: None,
                        ...
                        modifier: Some("cut into large cubes".to_string()),
                    },
                    Ingredient {
                        name: "unbleached all-purpose flour".to_string(),
                        amounts: vec![
                            Measure {
                                unit: "cup".to_string(),
                                upper_value: None,
                    ...
                    Ingredient {
                        name: "green onions".to_string(),
                        amounts: vec![Measure {
                            unit: "whole".to_string(),
                            upper_value: None,
                            value: 2.0,
                        }],
                        modifier: Some("thinly sliced".to_string()),
                    },
                    Ingredient {
                        name: "Salt and pepper".to_string(),
                        amounts: vec![],
                        modifier: None,
                    },
                ],
                directions: vec![
                    "In a small bowl, combine soy sauce, broth, vinegar, ginger, garlic, \
                     cornstarch, paprika, sambal oelek and sesame oil. Set aside."
                        .to_string(),
                    "In a small saucepan, combine sugar and water. Bring to a boil and simmer \
                     until mixture is slightly caramelized, about 5 minutes. Add soy mixture. \
                     Bring to a boil, whisking constantly. Keep sauce aside, off the heat."
                        .to_string(),
                    "In a large non-stick skillet, soften peppers for about 3 minutes in 30 ml (2 \
                     tablespoons) of oil. Set aside on a plate."
                        .to_string(),
                    "In a bowl, season chicken pieces with salt and pepper. Add flour and toss \
                     until well coated. Remove any excess flour. In the same skillet, brown half \
                     of the chicken at a time in remaining oil (150 ml/2/3 cup), making sure to \
                     always have about 1-cm (3/4-inch) of oil to fry chicken. Add oil, if needed. \
                     Drain on paper towels and keep warm. Repeat with remaining chicken. Discard \
                     oil."
                        .to_string(),
                    "In the same skillet, heat sauce. Add chicken and toss to coat well. Sprinkle \
                     with green onions."
                        .to_string(),
                    "Serve with rice and stir-fried vegetables such as bok choy or Chinese \
                     cabbage."
                        .to_string(),
                ],
                nutritional_information: Some(NutritionalInformation {
                    serving_size: Some(1),
                    calories_kcal: Some(540.0),
