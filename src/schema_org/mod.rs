...
impl LdJson {
    pub fn get_recipe(self) -> Option<Recipe> {
        match self {
            LdJson::Recipe(recipe) => Some(recipe),
            LdJson::Schema(schema) => {
                let graph = schema.graph?;

                let recipe = graph
                    .iter()
                    .find(|v| matches!(v, GraphContent::Recipe(_)))?;

                match recipe {
                    GraphContent::Recipe(recipe) => Some(recipe.clone()),
                    GraphContent::Json(_) => None,
                }
            }
        }
    }
...
mod tests {
    ...
    use crate::schema_org::GraphContent;
    ...
    fn graph_schema() -> Result<()> {
                ...
                "@graph":[
                    {
                        ...
                        "headline":"Quick &#038; Easy Red Lentil Dahl",
                        "datePublished":"2020-06-08T16:15:30+00:00",
                        "dateModified":"2023-12-19T15:11:25+00:00",
                        "wordCount":1095,
                        "commentCount":409,
                        "publisher":{"@id":"https://www.noracooks.com/#organization"},
                        "image":{"@id":"https://www.noracooks.com/red-lentil-dahl/#primaryimage"},
                        "thumbnailUrl":"https://www.noracooks.com/wp-content/uploads/2023/08/red-lentil-dahl-1-2.jpg","keywords":["30 minute meals","budget","indian","lentils"],
                        "articleSection":["30 Minute Recipes","Budget Vegan Recipes","Cuisine","Dinner","Gluten Free","High Protein","Indian-Inspired","Main Dish","Meal Prep","Meal Type","Method","Nut Free","Special Dietary Needs"],
                        "inLanguage":"en-US",
                        "potentialAction":[{"@type":"CommentAction","name":"Comment","target":["https://www.noracooks.com/red-lentil-dahl/#respond"]}]
                    },
                    {
                        "@type":["WebPage","FAQPage"],"@id":"https://www.noracooks.com/red-lentil-dahl/",
                        "url":"https://www.noracooks.com/red-lentil-dahl/",
                        "name":"Quick & Easy Red Lentil Dahl - Nora Cooks",
                        "isPartOf":{"@id":"https://www.noracooks.com/#website"},
                        "primaryImageOfPage":{"@id":"https://www.noracooks.com/red-lentil-dahl/#primaryimage"},"image":{"@id":"https://www.noracooks.com/red-lentil-dahl/#primaryimage"},"thumbnailUrl":"https://www.noracooks.com/wp-content/uploads/2023/08/red-lentil-dahl-1-2.jpg","datePublished":"2020-06-08T16:15:30+00:00","dateModified":"2023-12-19T15:11:25+00:00","description":"This 30-minute lentil dahl recipe features restaurant-quality flavors but is incredibly easy to make in one pot using affordable ingredients!","breadcrumb":{"@id":"https://www.noracooks.com/red-lentil-dahl/#breadcrumb"},"mainEntity":[{"@id":"https://www.noracooks.com/red-lentil-dahl/#faq-question-1693947134022"},{"@id":"https://www.noracooks.com/red-lentil-dahl/#faq-question-1693947140265"},{"@id":"https://www.noracooks.com/red-lentil-dahl/#faq-question-1693947142496"},{"@id":"https://www.noracooks.com/red-lentil-dahl/#faq-question-1693947141544"},{"@id":"https://www.noracooks.com/red-lentil-dahl/#faq-question-1693947143057"},{"@id":"https://www.noracooks.com/red-lentil-dahl/#faq-question-1693947143647"}],"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["https://www.noracooks.com/red-lentil-dahl/"]}]
                    },
                    {
                        "@type":"ImageObject","inLanguage":"en-US","@id":"https://www.noracooks.com/red-lentil-dahl/#primaryimage","url":"https://www.noracooks.com/wp-content/uploads/2023/08/red-lentil-dahl-1-2.jpg",
                        "contentUrl":"https://www.noracooks.com/wp-content/uploads/2023/08/red-lentil-dahl-1-2.jpg","width":1334,"height":1334,"caption":"close up on red lentil dahl topped with a drizzle of coconut milk and red chili flakes in a white bowl."
                    },
                    {
                        "@type":"BreadcrumbList",
                        "@id":"https://www.noracooks.com/red-lentil-dahl/#breadcrumb",
                        "itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.noracooks.com/"},{"@type":"ListItem","position":2,"name":"Meal Type","item":"https://www.noracooks.com/category/meal-type/"},{"@type":"ListItem","position":3,"name":"Main Dish","item":"https://www.noracooks.com/category/meal-type/main-dish/"},{"@type":"ListItem","position":4,"name":"Quick &#038; Easy Red Lentil Dahl"}]
                    },
                    {
                        "@type":"WebSite",
                        "@id":"https://www.noracooks.com/#website",
                        "url":"https://www.noracooks.com/",
                        "name":"Nora Cooks",
                        "description":"Simply Good Food",
                        "publisher":{"@id":"https://www.noracooks.com/#organization"},
                        "potentialAction":[
                            {"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"https://www.noracooks.com/?s={search_term_string}"},"query-input":{"@type":"PropertyValueSpecification","valueRequired":true,"valueName":"search_term_string"}}
                        ],
                        "inLanguage":"en-US"
                    },
                    {
                        "@type":"Organization",
                        "@id":"https://www.noracooks.com/#organization",
                        "name":"Nora Cooks",
                        "url":"https://www.noracooks.com/",
                        "logo":{
                            "@type":"ImageObject",
                            "inLanguage":"en-US",
                            "@id":"https://www.noracooks.com/#/schema/logo/image/",
                            "url":"https://www.noracooks.com/wp-content/uploads/2022/07/squarelogo.jpg",
                            "contentUrl":"https://www.noracooks.com/wp-content/uploads/2022/07/squarelogo.jpg",
                            "width":600,
                            "height":600,
                            "caption":"Nora Cooks"
                        },
                        "image":{"@id":"https://www.noracooks.com/#/schema/logo/image/"},
                        "sameAs":["https://www.facebook.com/noracookswithplants/","https://www.instagram.com/nora_cooks_vegan_/","https://www.pinterest.com/noracooks/"]
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "author":{"@id":"https://www.noracooks.com/#/schema/person/750d52d3520ab900b00ea775d3b353df"},
                        "description":"Made in one pot in just 30 minutes, this is guaranteed to be the easiest lentil dahl recipe you ever try! It’s rich and creamy, made with budget-friendly ingredients, and packed with plant protein and fiber.",
                        "datePublished":"2020-06-08T09:15:30+00:00",
                        "image":[
                            "https://www.noracooks.com/wp-content/uploads/2023/08/red-lentil-dahl-1-2.jpg",
                            "https://www.noracooks.com/wp-content/uploads/2023/08/red-lentil-dahl-1-2-500x500.jpg",
                            "https://www.noracooks.com/wp-content/uploads/2023/08/red-lentil-dahl-1-2-500x375.jpg",
                            "https://www.noracooks.com/wp-content/uploads/2023/08/red-lentil-dahl-1-2-480x270.jpg"
                        ],
                        "video":{
                            "name":"Red Lentil Dahl",
                            "description":"Ready in 30 minutes or less, this Indian Red Lentil Dahl is easy to make and full of flavor. Serve with rice and vegan naan for an incredible feast!",
                            "thumbnailUrl":"https://mediavine-res.cloudinary.com/image/upload/s--AEdL4NA7--/c_limit,f_auto,fl_lossy,h_1080,q_auto,w_1920/v1673299712/ezpaeqmz5sf3qgzld0l7.jpg",
                            "embedUrl":"https://video.mediavine.com/videos/ikpajilZg.js",
                            "contentUrl":"https://mediavine-res.cloudinary.com/video/upload/t_original/v1673299708/ikpajilZg.mp4",
                            "uploadDate":"2022-08-24T21:11:04+00:00","duration":"PT75S",
                            "@type":"VideoObject"
                        },
                        ...
                        "recipeIngredient":[
                            ...
                            "4 cups cooked brown or white rice","Vegan Naan"
                        ],
                        "recipeInstructions":[
                                {
                                    "@type":"HowToStep","text":"In a large pot or pan over medium heat, sauté the chopped onion in the olive oil for 5 minutes, stirring frequently. Then add the garlic and ginger and cook 1 more minute, until fragrant.",
                                    "name":"In a large pot or pan over medium heat, sauté the chopped onion in the olive oil for 5 minutes, stirring frequently. Then add the garlic and ginger and cook 1 more minute, until fragrant.",
                                    "url":"https://www.noracooks.com/red-lentil-dahl/#wprm-recipe-9546-step-0-0"},
                                {
                                    "@type":"HowToStep","text":"Add the garam masala, turmeric and red pepper flakes to the pan and stir into the onion mixture. Add a few tablespoons of water if the mixture is too dry.","name":"Add the garam masala, turmeric and red pepper flakes to the pan and stir into the onion mixture. Add a few tablespoons of water if the mixture is too dry.","url":"https://www.noracooks.com/red-lentil-dahl/#wprm-recipe-9546-step-0-1"},
                                {
                                    "@type":"HowToStep",
                                    "text":"Now add the dried lentils, canned tomatoes and their juices, coconut milk and vegetable broth to the pan. Stir well and turn the heat to high. Bring to a boil, then lower heat and simmer for about 15 minutes, until the lentils are cooked and soft. Stir occasionally.",
                                    "name":"Now add the dried lentils, canned tomatoes and their juices, coconut milk and vegetable broth to the pan. Stir well and turn the heat to high. Bring to a boil, then lower heat and simmer for about 15 minutes, until the lentils are cooked and soft. Stir occasionally.",
                                    "url":"https://www.noracooks.com/red-lentil-dahl/#wprm-recipe-9546-step-0-2"},
                                {
                                    "@type":"HowToStep",
                                    "text":"Squeeze the lemon juice into the pan, and stir in the spinach as well until wilted. Add salt to taste. I used 1 teaspoon.",
                                    "name":"Squeeze the lemon juice into the pan, and stir in the spinach as well until wilted. Add salt to taste. I used 1 teaspoon.",
                                    "url":"https://www.noracooks.com/red-lentil-dahl/#wprm-recipe-9546-step-0-3"},
                                {
                                    "@type":"HowToStep","text":"Serve with brown or white rice and Vegan Naan. Enjoy!",
                                    "name":"Serve with brown or white rice and Vegan Naan. Enjoy!",
                                    "url":"https://www.noracooks.com/red-lentil-dahl/#wprm-recipe-9546-step-0-4"
                                }
                            ],
                                "aggregateRating":{"@type":"AggregateRating","ratingValue":"4.96","ratingCount":"171","reviewCount":"10"},
                                "review":[{"@type":"Review","reviewRating":{"@type":"Rating","ratingValue":"5"},
                                "reviewBody":"Easy and delicious! I cooked it for my friend's family and they loved it - including their little boy!",
                                "author":{"@type":"Person","name":"Rachel"},"datePublished":"2025-02-21"},
                            {
                                "@type":"Review",
                                "reviewRating":{"@type":"Rating","ratingValue":"5"},
                                "reviewBody":"I'm relatively new to lentils. I've never had this type of dish before. And it's absolutely delicious. Definitely a keeper. Thank you for sharing!","author":{"@type":"Person","name":"SH"},"datePublished":"2025-02-14"
                            },
                            {
                                "@type":"Review","reviewRating":{"@type":"Rating","ratingValue":"5"},"reviewBody":"Exquisite, thank you so much","author":{"@type":"Person","name":"Lars White"},
                                "datePublished":"2025-02-11"
                            },
                            {"@type":"Review","reviewRating":{"@type":"Rating","ratingValue":"5"},"reviewBody":"Great recipe that is easy, is so good for you and smells amazing. Thank you!","author":{"@type":"Person","name":"Maureen"},"datePublished":"2025-02-10"},{"@type":"Review","reviewRating":{"@type":"Rating","ratingValue":"5"},"reviewBody":"shockingly good!!! I thought this would be good, but not THIS good. Thank you!! I doubled the recipe so theres enough for the week : )","author":{"@type":"Person","name":"NZ"},"datePublished":"2025-02-09"},{"@type":"Review","reviewRating":{"@type":"Rating","ratingValue":"5"},"reviewBody":"Absolutely love this recipe and so does the whole family. This is a weekly meal for us. \r\nCan I ask is there an option to make it oil free? \r\nThank you!","author":{"@type":"Person","name":"Izzy"},"datePublished":"2025-02-04"},{"@type":"Review","reviewRating":{"@type":"Rating","ratingValue":"5"},"reviewBody":"Made this tonight so tasty and simple to make will definitely make this again.","author":{"@type":"Person","name":"Joanne"},"datePublished":"2025-01-29"},{"@type":"Review","reviewRating":{"@type":"Rating","ratingValue":"5"},"reviewBody":"This was really good! I've never attempted to make Indian food due to the complexity and variety of spices needed. This recipe solves this since you probably one need to buy one spice (garam masala).\r\n\r\nThe outcome was fabulous when served with naan, although I ate some by itself and it was just as good, similar to a soup.","author":{"@type":"Person","name":"Matt"},"datePublished":"2025-01-27"},
                            {"@type":"Review","reviewRating":{"@type":"Rating","ratingValue":"5"},"reviewBody":"Loved this! I added smoked paprika and Sriracha sauce minus the red pepper flakes. Definitely added to my favorite list! Yum","author":{"@type":"Person","name":"Suzanne"},"datePublished":"2025-01-25"},
                            {"@type":"Review","reviewRating":{"@type":"Rating","ratingValue":"5"},"reviewBody":"Wow, it tastes amazing!! It’s so easy to make and i got lots of compliments for it. Served it with garlic naan and rice and will definitely make it again😍😍","author":{"@type":"Person","name":"Nici"},"datePublished":"2025-01-14"}],
        ...
        let recipe: LdJson = serde_path_to_error::deserialize(jd)?;

        assert!(matches!(recipe, LdJson::Schema(_)));

        if let LdJson::Schema(schema) = recipe {
            assert!(schema.graph.is_some());
            let graph = schema.graph.unwrap();

            let recipe = graph.iter().find(|v| matches!(v, GraphContent::Recipe(_)));
            assert!(recipe.is_some());
            if let GraphContent::Recipe(recipe) = recipe.unwrap() {
                assert_eq!(recipe.name, "Quick & Easy Red Lentil Dahl");
            }
        }
